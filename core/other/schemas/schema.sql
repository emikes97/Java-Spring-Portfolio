...
--- Run this to fix the edge case of not having a constraint for a unique cart.
...
-- Useful indexes (optional depending on queries)
-- CREATE INDEX idx_orders_address_gin ON orders       USING GIN (address_to_send jsonb_path_ops);
