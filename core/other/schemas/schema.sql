...
ALTER TABLE customer_payment_methods
ADD COLUMN tokenStatus token_status NOT NULL DEFAULT 'PENDING';
...
create table customer_payment_methods(
    ...
    created_at timestamptz NOT NULL DEFAULT NOW(),
    tokenStatus token_status NOT NULL DEFAULT 'PENDING',
    is_default boolean NOT NULL DEFAULT TRUE
);
...
-- If you want to enforce one cart per customer, uncomment:
