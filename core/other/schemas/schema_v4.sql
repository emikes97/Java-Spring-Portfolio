...
DROP TYPE IF EXISTS order_outbox_status CASCADE;
...
CREATE TYPE checkout_status AS ENUM('PENDING', 'PROCESSING', 'ORDER_CREATED', 'TRANSACTION_READY', 'TRANSACTION_PROCESSING', 'TRANSACTION_WAITING_CLIENT_CONFIRMATION', 'COMPLETED', 'FAILED');
...
DROP TABLE IF EXISTS checkout_job CASCADE;
